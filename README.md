# Password Generator [![License: LGPL v3](https://img.shields.io/badge/License-LGPL_v3-orange.svg)](COPYING.LESSER)
**Password Generator** is a kind of
[digital safe](https://fr.wikipedia.org/wiki/Coffre-fort_num%C3%A9rique) for
passwords that doesn’t store any one. Based a master password and on savable
definitions, like domain names, lengths, etc., it generates/calculates strong
passwords through a
...
Lesser General Public License along with the **Password Generator app** (Links:
